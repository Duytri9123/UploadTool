...
const I18N = {
  vi: {
    ...
    lbl_dl_post_process: 'Xử lý video sau khi tải',
    lbl_dl_burn_vi: 'Phụ đề tiếng Việt',
    ...
    lbl_burn_subs: 'Đốt phụ đề',
    lbl_blur_original: 'Làm mờ chữ gốc',
    lbl_translate_subs: 'Dịch sang tiếng Việt',
    lbl_burn_vi_subs: 'Đốt phụ đề tiếng Việt',
  ...
  en: {
    ...
    lbl_dl_post_process: 'Post-download processing',
    lbl_dl_burn_vi: 'Vietnamese subtitles',
    ...
    lbl_burn_subs: 'Burn subtitles',
    lbl_blur_original: 'Blur original text',
    lbl_translate_subs: 'Translate to Vietnamese',
    lbl_burn_vi_subs: 'Burn Vietnamese subtitles',
